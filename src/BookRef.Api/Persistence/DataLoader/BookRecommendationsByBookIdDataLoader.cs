...
{
    public class BookRecommendationsByBookIdDataLoader : BatchDataLoader<long, BookRecommedation>
    {
        private readonly IDbContextFactory<BookRefDbContext> _dbContextFactory;

        public BookRecommendationsByBookIdDataLoader(
            ...
            CancellationToken cancellationToken)
        {
            ...
            return await dbContext.BookRecommedations
                .Where(s => keys.Contains(s.SourceBookId))
